...
internal static class OniUiTokens
{
   ...
   public static float SectionRuleHeight =>
      CacheOpt(ref _sectionRuleHeight, Lift.SectionRuleHeight, ScopeUiDefaults.SectionRuleHeight);
   ...
   public static Color RowNeedsTechColor =>
      CacheOpt(ref _rowNeedsTechColor, Lift.RowNeedsTechColor, ScopeUiDefaults.RowNeedsTechColor);
